            ...
            <div class="section-style mb-4">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="gstin" name="gstin" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control custom-input" id="address" name="address" rows="2"></textarea>
                    ...
                    <div class="col-md-12 mb-3 mt-4">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-custom px-5">
                                <i class="bi bi-check2-circle me-1"></i> Create Vendor
                            </button>
...
$(function(){
    $('#vendor-form').on('submit', function(e){
        ...
        .then(d => { showAlert(d.message||'Created'); setTimeout(() => window.location.href='{{ route("vendors.index") }}', 900); })
        .catch(err => {
            ...
            } else showAlert('Error creating vendor');
        });
    });
});
</script>
