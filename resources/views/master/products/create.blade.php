            ...
            <div class="section-style mb-4">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <div class="mt-2" id="main_image_preview_container" style="display:none;"><img id="main_image_preview_img" src="" style="max-height:80px;"/></div>
                    </div>
                    ...
                    <div class="col-md-12 mb-3 mt-4">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-custom px-5" id="submitBtn">
                                <i class="bi bi-check2-circle me-1"></i> Create Product
                            </button>
...
<script>$(function(){ if (window.Product && typeof Product.initForm === 'function') Product.initForm('#product-form'); });</script>
@endpush
