...
<div class="card form-card shadow-lg border-0">
    <div class="card-body p-5">
        <form id="terms-form" method="POST" action="{{ route('methodologies.store') }}">
            @csrf
            ...
            <div class="section-style mb-4">
                ...
                <div class="row g-4 mt-2">
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control custom-input" id="title" name="title" placeholder="e.g., Standard Quotation Methodology" required>
            ...
            <div class="d-flex gap-2 pt-2">
                ...
                <button type="submit" class="btn btn-custom px-5 py-2" id="submitBtn">
                    <i class="bi bi-check-circle me-2"></i> Create Methodology
                </button>
            </div>
        </form>
    </div>
...
$(document).ready(function(){
    console.log('Methodology Create Page - Initializing Editor');
    ...
    $('#terms-form').on('submit', function(e){
        ...
        fetch('{{ route("methodologies.store") }}', {
            method: 'POST',
            body: fd,
            headers: { 
        ...
        .then(d => { 
            showAlert(d.message||'Methodology created successfully', 'success'); 
        ...
        .catch(err => {
            ...
            if(err.validation && err.validation.errors){
                ...
                showAlert('Error creating Methodology', 'error');
            }
        });
    });
});
