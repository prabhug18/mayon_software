            ...
            <div class="section-style mb-4">
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="quotation_prefix" name="quotation_prefix" placeholder="E.g. QT/2627/" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control custom-input" id="quotation_start_number" name="quotation_start_number" value="1" min="1" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="po_prefix" name="po_prefix" placeholder="E.g. PO/2627/" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control custom-input" id="po_start_number" name="po_start_number" value="1" min="1" />
