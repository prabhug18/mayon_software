            ...
            <div class="section-style mb-4">
                ...
                <div class="row mt-5">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="name" name="name" value="{{ $company->name }}" />
                        <div class="invalid-feedback" id="name-error"></div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Contact Person</label>
                        <input type="text" class="form-control custom-input" id="contact_person" name="contact_person" value="{{ $company->contact_person }}" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="mobile" name="mobile" value="{{ $company->mobile }}" />
                        <div class="invalid-feedback" id="mobile-error"></div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Email ID</label>
                        <input type="email" class="form-control custom-input" id="email" name="email" value="{{ $company->email }}" />
                        <div class="invalid-feedback" id="email-error"></div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Address</label>
                        <input type="text" class="form-control custom-input" id="address" name="address" value="{{ $company->address }}" />
                        <div class="invalid-feedback" id="address-error"></div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">GST No</label>
                        <input type="text" class="form-control custom-input" id="gst_no" name="gst_no" value="{{ $company->gst_no }}" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-2" id="logo_preview_container">
                            @if($company->logo)
                                <img id="logo_preview_img" src="{{ asset($company->logo) }}" alt="logo" style="max-height:80px;"/>
                            @else
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="mt-2" id="authorized_preview_container">
                            @if($company->authorized_image)
                                <img id="authorized_preview_img" src="{{ asset($company->authorized_image) }}" alt="authorized" style="max-height:80px;"/>
                            @else
                                <img id="authorized_preview_img" src="" alt="authorized preview" style="max-height:80px; display:none;"/>
                            @endif
                        </div>
                    </div>
                    <div class="col-md-12 mb-3 mt-4">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-custom px-5" id="submitBtn">
                                <i class="bi bi-check2-circle me-1"></i> Update Company
                            </button>
...
<script>$(function(){ if (window.Company && typeof Company.initEditForm === 'function') Company.initEditForm('#company-edit-form', {{ $company->id }}); });</script>
@endpush
