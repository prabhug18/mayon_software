            ...
            <form id="service-form" method="POST" action="{{ route('services.update', $service->id) }}">
                ...
                <div class="row mt-4">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control custom-input" id="name" name="name" value="{{ $service->name }}" placeholder="e.g. Flooring Installation" required>
                        <div class="invalid-feedback" id="name-error"></div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="category" class="form-label">Category</label>
                        <input type="text" class="form-control custom-input" id="category" name="category" value="{{ $service->category }}" placeholder="e.g. Installation">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control custom-input" id="default_gst_percentage" name="default_gst_percentage" value="{{ $service->default_gst_percentage }}">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control custom-input" id="description" name="description" rows="3" placeholder="Provide a brief description of the service...">{{ $service->description }}</textarea>
                    <div class="invalid-feedback" id="description-error"></div>
                </div>
                
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-custom px-5 py-2">Update Service</button>
...
$(function(){
    $('#service-form').on('submit', function(e){
        ...
        .then(d => { showAlert(d.message||'Updated'); setTimeout(() => window.location.href='{{ route("services.index") }}', 900); })
        .catch(err => {
            ...
            } else showAlert('Error updating service');
        });
    });
});
</script>
