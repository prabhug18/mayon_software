            ...
            <form id="po-form">
                ...
                <div class="d-flex justify-content-center mb-3 align-items-center">
                    <div class="position-relative me-2" style="width: 350px;">
                        <input class="form-control custom-input" id="supplier_text" placeholder="Search supplier...">
                ...
                <div class="section-style mb-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="po_number" name="po_number" class="form-control custom-input" style="max-width:300px;" readonly />
                            <div class="invalid-feedback" id="po_number-error"></div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Date</label>
                            <input type="date" id="po_date" name="po_date" class="form-control custom-input" style="max-width:300px;" />
                            <div class="invalid-feedback" id="po_date-error"></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Company Name</label>
                            <select name="company_id" id="company_id" class="form-select custom-input me-2" style="max-width:300px;">
                                <option value="">Choose Company</option>
                                @foreach($companies as $comp)
                                    <option value="{{ $comp->id }}" data-po-prefix="{{ $comp->po_prefix }}">{{ $comp->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-4 mb-3">
                ...
                <div class="section-style mb-4">
                    <div id="productContainer" class="mb-4">
                        ...
                        <div class="d-flex justify-content-center mb-3 align-items-center">
                            ...
                            <button type="button" id="add-product-btn" class="add-btn-custom btn-sm">Add Product</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="text-center">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="notes" name="notes" class="form-control" rows="3" placeholder="Optional notes for this PO"></textarea>
