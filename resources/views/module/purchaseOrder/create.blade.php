            ...
            <form id="po-form">
                ...
                <div class="d-flex justify-content-center mb-5 align-items-center">
                    <div class="position-relative me-2" style="width: 350px;">
                        <input class="form-control custom-input" id="supplier_text" placeholder="Search supplier by name...">
                    ...
                    <div class="row g-4 mt-2">
                        <div class="col-md-3">
                            <div class="p-3 rounded-4 bg-light bg-opacity-50 text-center h-100 border">
                                ...
                                <div class="fw-bold" id="supplier_company">-</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="p-3 rounded-4 bg-light bg-opacity-50 text-center h-100 border">
                                <small class="text-muted d-block mb-1">Contact Person</small>
                                <div class="fw-bold" id="supplier_contact">-</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="p-3 rounded-4 bg-light bg-opacity-50 text-center h-100 border">
                                <small class="text-muted d-block mb-1">Phone</small>
                                <div class="fw-bold" id="supplier_phone">-</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="p-3 rounded-4 bg-light bg-opacity-50 text-center h-100 border">
                                <small class="text-muted d-block mb-1">GSTIN</small>
                                <div class="fw-bold" id="supplier_gst">-</div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="p-3 rounded-4 bg-light bg-opacity-50 h-100 border">
                                <small class="text-muted d-block mb-1">Address</small>
                                <div class="fw-bold" id="supplier_address">-</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section-style mb-4">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" id="po_number" name="po_number" class="form-control custom-input" readonly />
                            <div class="invalid-feedback" id="po_number-error"></div>
                        </div>
                        <div class="col-md-4 mb-3">
                            <label class="form-label">Date <span class="text-danger">*</span></label>
                            <input type="date" id="po_date" name="po_date" class="form-control custom-input" />
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="company_id" id="company_id" class="form-select custom-input me-2">
                ...
                <div class="section-style mb-4">
                    ...
                    <div id="productContainer" class="mt-4 mb-2">
                        <div class="row justify-content-center g-2 align-items-center">
                            ...
                            <div class="col-auto">
                                <button type="button" id="add-product-btn" class="btn btn-primary px-4">
                ...
                <div class="mt-4">
                    ...
                    <textarea id="notes" name="notes" class="form-control custom-input" rows="3" placeholder="Optional notes for this PO"></textarea>
